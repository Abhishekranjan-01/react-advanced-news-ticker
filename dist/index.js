...
var TickerStates = (exports.TickerStates = Object.freeze({
  Stopped: 0,
  Running: 1,
  Paused: 2,
}));
...
var NewsTicker = (function (_Component) {
  ...
  function NewsTicker(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (NewsTicker.__proto__ || Object.getPrototypeOf(NewsTicker)).call(
        this,
        props
      )
    );
    ...
    _this.state = {
      ...
      moving: 0,
      moveInterval: null,
      items: (Array.isArray(_this.props.children) && _this.props.children) || [
    ...
    },
    {
      ...
      value: function init() {
        this.element.current.style.height =
          this.props.rowHeight * this.props.maxRows + "px";
      ...
      value: function start() {
        ...
        this.setState(
          function (_, props) {
            return {
              currState: 1,
              items: (Array.isArray(_this2.props.children) &&
                _this2.props.children) || [_this2.props.children],
            };
          },
          function () {
    ...
    },
    {
      ...
      value: function pause() {
        ...
        if (!this.state.paused)
          this.setState({ paused: 1 }, function () {
    ...
    },
    {
      ...
      value: (function () {
        var _ref = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(newList) {
            var _this7 = this;
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 4:
                      ...
                      setTimeout(function () {
                        firsLiEl.style.cssText =
                          "margin: 0;transition: margin " + speed + "ms;";
                      }, 0);
                ...
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    ...
                    case 4:
                      ...
                      itemsCopy = [].concat(
                        _toConsumableArray(this.state.items)
                      );
    ...
    },
    {
      ...
      value: (function () {
        var _ref4 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(newList) {
            var _this8 = this;
                ...
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    ...
                    case 3:
                      ...
                      setTimeout(function () {
                        return (firsLiEl.style.cssText =
                          "margin: -" +
                          _this8.props.rowHeight +
                          "px 0 0 0; transition: all " +
                          _this8.props.speed +
                          "ms;");
                      }, 0);
    ...
    },
    {
      ...
      value: function getState() {
        if (this.state.paused) return TickerStates.Paused;
          ...
          return this.state.currState
            ? TickerStates.Running
            : TickerStates.Stopped;
      },
    },
    {
      key: "checkSpeed",
        ...
        return _react2.default.createElement(
          "ul",
          {
            ...
            onMouseEnter: function onMouseEnter() {
              _this9.props.pauseOnHover &&
                _this9.state.currState &&
                _this9.pause();
            },
